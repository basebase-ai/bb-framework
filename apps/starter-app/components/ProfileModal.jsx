/**
 * ProfileModal - User profile editor with photo upload and password management
 */
...
export function ProfileModal({ opened, onClose }) {
  ...
  const authInfo = useMemo(() => {
    if (!user) return { hasPassword: false, hasGoogle: false, providers: /** @type {string[]} */ ([]) };
      ...
      <Stack gap="lg">
        ...
        <Box>
          ...
          <Collapse in={showPasswordSection}>
            <Stack gap="sm" mt="md" p="md" style={{ background: "var(--mantine-color-gray-1)", borderRadius: 8 }}>
