      ...
      <Stack align="center" py="xl" gap="lg">
        <Box
          style={{
            ...
            height: 120,
            borderRadius: "50%",
            background: "linear-gradient(135deg, rgba(34, 139, 230, 0.2) 0%, rgba(34, 139, 230, 0.05) 100%)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
          }}
        >
          <IconBook size={60} stroke={1.2} color="var(--mantine-color-blue-5)" />
        </Box>
          ...
          <Group justify="space-between" wrap="nowrap">
            <Stack gap="xs" style={{ flex: 1, minWidth: 0 }}>
              <Group gap="sm" wrap="nowrap">
                <IconBook size={20} color="var(--mantine-color-blue-5)" />
